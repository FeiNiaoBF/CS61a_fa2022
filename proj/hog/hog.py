...
def tail_points(opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    assert opponent_score >= 0, "Score is a non-negative integer"
...
def always_roll(n):
    ...
    3
    """
    assert n >= 0 and n <= 10, "Please enter an integer from 0 to 10"
    # BEGIN PROBLEM 6
    def strategy(scores0, scores1):
        return n
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    temp = tail_points(opponent_score)
    new_score = score + temp
    square_score = square_update(0, score, opponent_score)
    if new_score >= GOAL or square_score - score >= 12:
        return 0
